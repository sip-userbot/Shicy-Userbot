...
from ShicyXd import CMD_HELP, tgbot
from ShicyXd.shicy import shicy_cmd, edit_delete, reply_id
...
@shicy_cmd(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@shicy_cmd(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/shicyxC0d:same> [Support]<buttonurl:https://t.me/ShicyyXCode>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/shicyxC0d:same> [Support]<buttonurl:https://t.me/ShicyyXCode>`\
    "
    }
)
