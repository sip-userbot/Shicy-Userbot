...
@shicy_cmd(pattern="(get|del) var(?: |$)(\\w*)", allow_sudo=False)
...
@shicy_cmd(pattern="set var (\\w*) ([\\s\\S]*)", allow_sudo=False)
...
@shicy_cmd(pattern="(usage|kuota|dyno)(?: |$)")
...
@shicy_cmd(pattern="getdb ?(.*)", allow_sudo=False)
...
@shicy_cmd(pattern="setdb ?(.*)", allow_sudo=False)
...
@shicy_cmd(pattern="deldb ?(.*)", allow_sudo=False)
...
CMD_HELP.update(
    {
        ...
        \n  »  **Kegunaan : **Tambahkan Variabel Baru Atau Memperbarui Variabel Setelah Menyetel Variabel shicy-Userbot Akan Di Restart.\
