...
from ShicyXd import AFKREASON, BOTLOG_CHATID, PM_AUTO_BAN
from ShicyXd.shicy import shicy_cmd, shicy_handler
...
@shicy_handler(incoming=True, func=lambda e: e.is_private)
async def afk_on_pm(sender):
    ...
    global afk_end
    back_alivee = datetime.now()
    shicyBot = await sender.client.get_me()
    owner = shicyBot.first_name
    afk_end = back_alivee.replace(microsecond=0)
