...
from ShicyXd import CMD_HELP, BLACKLIST_CHAT, LOGS
...
@shicy_cmd(pattern="spam ([\\s\\S]*)")
async def nyespam(event):
    if event.chat_id in BLACKLIST_CHAT:
        return await event.edit(get_string("shicy_1"))
...
@shicy_cmd(pattern="(delayspam|dspam) ([\\s\\S]*)")
