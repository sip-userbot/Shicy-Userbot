...
from ShicyXd import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
from ShicyXd.shicy import shicy_cmd, eor, humanbytes, progress, run_cmd
from ShicyXd.shicy.FastTelethon import download_file, upload_file
from Stringchiy import get_string


@shicy_cmd(pattern="download(?: |$)(.*)")
