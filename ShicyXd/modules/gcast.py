...
from ShicyXd import BLACKLIST_GCAST
from ShicyXd import CMD_HANDLER as cmd
from ShicyXd import CMD_HELP, DEVS, HEROKU_API_KEY, HEROKU_APP_NAME
...
@shicy_cmd(pattern="addblacklist(?:\\s|$)([\\s\\S]*)")
async def add(event):
...
@shicy_cmd(pattern="delblacklist(?:\\s|$)([\\s\\S]*)")
async def _(event):
