...
from ShicyXd import CMD_HELP, LOGS
from ShicyXd.modules.sql_helper import broadcast_sql as sql
from ShicyXd.shicy import shicy_cmd, eor, parse_pre
from Stringchiy import get_string


@shicy_cmd(pattern=r"sendto ?(.*)")
