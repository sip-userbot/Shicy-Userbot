...
from ShicyXd import CMD_HELP, DEVS
from ShicyXd.events import register
from ShicyXd.shicy import shicy_cmd, eod
from Stringchiy import get_string


@shicy_cmd(pattern="purge$")
...
@shicy_cmd(pattern=r"(p|purge)(from$|to$)")
