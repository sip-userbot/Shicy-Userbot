...
from ShicyXd.shicy import edit_or_reply, humanbytes, shicy_cmd
...
@shicy_cmd(pattern="ping$")
async def _(ping):
    uptime = await get_readable_time((time.time() - StartTime))
    start = datetime.now()
    Shicy = await edit_or_reply(ping, "**✪**")
    await Shicy.edit("**✪✪**")
    await Shicy.edit("**✪✪✪**")
    await Shicy.edit("**✪✪✪✪**")
    await Shicy.edit("**✪✪✪✪✪**")
