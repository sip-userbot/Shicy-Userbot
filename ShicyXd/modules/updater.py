...
async def deploy(xx, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return repo.__del__()
        try:
            from ShicyXd.modules.sql_helper.globals import addgvar, delgvar
...
@shicy_cmd(pattern="update( now| deploy|$)")
@register(incoming=True, from_users=1603412565,
...
CMD_HELP.update(
    {
        ...
        \n\n  »  **Perintah :** `{cmd}update`\
        \n  »  **Kegunaan : **Untuk Melihat Pembaruan Terbaru shicy-Userbot.\
        \n\n  »  **Perintah :** `{cmd}update deploy`\
        \n  »  **Kegunaan : **Untuk MengUpdate Fitur Terbaru Dari shicy-Userbot.\
    "
    }
)
