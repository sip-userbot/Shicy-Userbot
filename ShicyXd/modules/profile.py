...
@shicy_cmd(pattern="name", allow_sudo=False)
...
@shicy_cmd(pattern="setpfp$", allow_sudo=False)
...
@shicy_cmd(pattern="setbio (.*)", allow_sudo=False)
...
@shicy_cmd(pattern="username (.*)", allow_sudo=False)
...
@shicy_cmd(pattern="delpfp", allow_sudo=False)
