...
from ShicyXd import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY, WATCH_COUNTRY
...
@shicy_cmd(pattern="remove(?: |$)(.*)", allow_sudo=False)
async def _(event):
    if event.fwd_from:
        return
    if event.is_private:
...
@shicy_cmd(pattern="doublestruck(?: |$)(.*)")
