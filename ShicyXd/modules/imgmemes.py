...
from ShicyXd.shicy import shicy_cmd, bash, deEmojify
...
async def FakeGoogleSearch(event):
    ...
    font1 = ImageFont.truetype(
        "ShicyXd/shicy/styles/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype(
        "ShicyXd/shicy/styles/ProductSans-Light.ttf", 23)
...
CMD_HELP.update(
    {
        ...
        \n  •  **Example  : **{cmd}tweet @shicy.gans (harus pake . [titik])\
    "
    }
)
