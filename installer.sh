REPO="https://github.com/sip-userbot/Shicy-Userbot.git"
DIR="/root/sip-userbot"
    ...
    if [ $OKTETO_TOKEN ]
        ...
        then
            if [ -d $DIR/vcbot ]
                ...
                echo -e "Cloning SHICY.."
                git clone https://github.com/sip-userbot/Shicy-Userbot $DIR/Shicy-Userbot 
            fi
